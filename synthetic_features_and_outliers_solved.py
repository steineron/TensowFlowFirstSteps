...
# YOUR CODE HERE
y = calibration_data["predictions"]
x = calibration_data["targets"]
N = len(x)
print ('N: ' +str(N))
...
# YOUR CODE HERE
california_housing_dataframe["rooms_per_person_clipped"] = california_housing_dataframe['rooms_per_person'].apply(lambda x: min(x,5))
calibration_data_clipped = train_model(
    learning_rate=0.05,
    steps=500,
    batch_size=5,
    input_feature="rooms_per_person_clipped"
)
